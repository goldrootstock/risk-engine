...
|---|---|---|---|
| `fred_dgs10_2020-03_04.json` | FRED, series DGS10 (Board of Governors H.15; "Public Domain: Citation Requested") | Captured from `/fred/series/observations` (API v1 endpoint, key as query parameter) on 2026-09-13, 2020-03-02..2020-04-30 | The response does not echo the key; 2020-04-10 (Good Friday) is `"."`, FRED's missing-value marker; `count` equals the number of observations |
