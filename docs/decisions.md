...
| 역사적 구간 12개 | `config/stress_scenarios.toml [historical]` (각 행에 `why`) | 같음 | 2008 리먼·최악주, 2020 코로나, **2020-04-20(모델이 놓친 날, 필수)**, 2022 금리(연간·6월), 2013 테이퍼, 2014 유가, 2001 9/11, 2016 대선, 2021 텍사스, 2022 우크라이나. 선택 근거는 파일과 노트 07 §1 | — | 목록은 선택이다. 파일 해시가 실행에 남는다 |
